...
require 'omniauth/facebookposts/signed_request'
require 'openssl'
require 'rack/utils'
require 'uri'
...
module OmniAuth
  module Strategies
    class Facebookposts < OmniAuth::Strategies::OAuth2
      ...
      rescue OmniAuth::Facebookposts::SignedRequest::UnknownSignatureAlgorithmError => e
      ...
      def signed_request_from_cookie
        @signed_request_from_cookie ||= raw_signed_request_from_cookie && OmniAuth::Facebookposts::SignedRequest.parse(raw_signed_request_from_cookie, client.secret)
      end
